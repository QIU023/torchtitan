...
class BlockLayoutTables:
    ...
    committed, which is the loop-style stage-to-rank assignment. A v-shaped
    assignment revisits a rank out of that order and is refused by the
    contiguity check in ``infer_block_layout_tables``.
    """
