...
def set_tensor_parallel_sharding_config(
    ...
    MoE internals are declared by ``set_expert_parallel_sharding_config``;
    this adds the latent projections around them.
    """
