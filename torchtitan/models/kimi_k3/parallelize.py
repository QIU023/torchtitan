...
def _kimi_k3_vit_dep_split(
    ...
    num_virtual_stages, num_layers, _, output_weight = _get_pipeline_metadata(
    ...
    # (input_weight 0) and drops the one core places.
...
def pipeline_kimi_k3(
    ...
    **kwargs,
    ...
    between the stage that commits them and the rank's later stages; the result
    is bitwise the on-device cache.
