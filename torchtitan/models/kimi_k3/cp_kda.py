...
class ContextParallelInnerKDA(CPInnerAttention, InnerKDA):
    ...
    def cp_shard_metadata(
        ...
        *,
        ...
        """Attach rank-local KDA routing for the configured CP token layout."""
        assert isinstance(
            backend_config, cls.Config
        ), "Decoder must pass ContextParallelInnerKDA.Config."
        ...
        input_dict["kda_cp_routing"] = _build_kda_context_parallel_routing(
            ...
            conv_kernel_size=backend_config.conv_kernel_size,
            load_balancer=None if load_balancer is None else "headtail",
