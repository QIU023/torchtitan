...
class TrainingConfig:
    ...
    mixed_precision_param: Literal["bfloat16", "float32", "float64"] = "bfloat16"
    """
    ...
    mixed_precision_reduce: Literal["bfloat16", "float32", "float64"] = "float32"  # upstream #4597 (c48650f06), not in this base
    """
