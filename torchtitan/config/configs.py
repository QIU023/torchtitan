...
class LoadBalancer(Configurable):
    """Base class for load-balancing strategies."""

    @dataclass(kw_only=True, slots=True)
    class Config(Configurable.Config):
        """Base configuration for load-balancing strategies."""
...
class ParallelismConfig:
    ...
    context_parallel_load_balancer: Annotated[
        LoadBalancer.Config | None, tyro.conf.Suppress
    ] = field(
    ...
    head-tail sharding. Set to None for contiguous sharding without token
    reordering.
    """
