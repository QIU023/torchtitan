...
Phase 4c: ModelSpec registration is live. Use the flavors below via::
    ...
    torchrun ... --module kimi_k3 --config <flavor>
...
from torchtitan.experiments.kimi_k3.kimi_linear.attn_res_model import (
...
from torchtitan.experiments.kimi_k3.kimi_linear.parallelize import parallelize_kimi_linear
from torchtitan.experiments.kimi_k3.kimi_linear.pipeline_adapter import (
