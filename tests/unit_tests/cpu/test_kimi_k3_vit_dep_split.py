...
from torchtitan.distributed.pipeline_parallel import llm_split_with_pinned_modules
from torchtitan.models.kimi_k3.parallelize import (
    _KIMI_K3_FIRST_STAGE_FQNS,
    _kimi_k3_last_stage_modules,
...
def _split(tower: bool, schedule: str, num_layers: int, *, vit_dep: bool):
    ...
    return llm_split_with_pinned_modules(
        model,
